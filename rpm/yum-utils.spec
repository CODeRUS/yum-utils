...
%files
%defattr(-, root, root)
%doc yum-utils/README yum-utils/yum-util-cli-template
%doc yum-utils/COPYING
%doc yum-utils/plugins/README
...
%defattr(-, root, root)
%doc yum-utils/updateonboot/README yum-utils/COPYING
...
%defattr(-, root, root)
%doc yum-utils/plugins/versionlock/README yum-utils/COPYING
...
%doc yum-utils/plugins/post-transaction-actions/sample.action
